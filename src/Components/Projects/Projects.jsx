            ...
            <div className='flex justify-end p-4'>
              ...
              <div className='flex flex-col pt-5'>
                ...
                <div className='flex gap-8 mt-4 px-8'>
                  ...
                  {selectedProject.imagesLink && (
                    <a href={selectedProject.imagesLink} target='_blank' rel='noopener noreferrer' className='w-1/2 bg-gray-600 hover:bg-purple-600 text-gray-300 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center'>
                      View Images
                    </a>
                  )}
                </div>
